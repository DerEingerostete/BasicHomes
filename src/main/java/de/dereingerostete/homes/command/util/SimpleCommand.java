...
public abstract class SimpleCommand extends Command {
     ...
     * @param arguments The amount of specified arguments
     */
    public abstract void execute(@NotNull Player player, @NotNull String[] args, int arguments);
    ...
    public void sendMessage(@NotNull CommandSender sender, @NotNull String key, @NotNull Object... parameters) {
